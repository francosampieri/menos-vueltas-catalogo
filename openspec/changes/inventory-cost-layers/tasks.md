...
- [x] 3.2 Simplificar la tabla principal de Inventario a Producto, Proveedor, Modalidad, Saldo y Valor total; hacer la fila completa accesible por click/Enter/Espacio, con hover, foco visible y scroll interno móvil sin ampliar body. Mover tandas, FIFO, faltantes, composición e historial al detalle de sólo lectura con etiquetas humanas y sin UUID/códigos técnicos, PII ni cobros.
