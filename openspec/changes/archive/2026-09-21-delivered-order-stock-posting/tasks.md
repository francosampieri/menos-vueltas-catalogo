...
- [x] 3.5 Verificación manual autorizada en operación real: una prueba controlada confirmó que al marcar Entregado se creó exactamente una Venta automática para la línea con stock gestionado y que una Corrección positiva vinculada preservó su saldo inicial y final; no hubo cobro ni cambios en B2C, B2B, catálogo o Finanzas.
