...
- [x] 4.4 Verificado manualmente y aprobado por el responsable en desktop y mobile: tabla de Inventario, detalle de tandas, historial de movimientos y selector de corrección con datos operativos existentes sólo en modo lectura. Se confirmaron saldos preservados, referencias humanas sin UUID/PII y que no se registraron movimientos durante la revisión.
...
- La verificación manual 4.4 fue aprobada por el responsable en desktop y mobile; no se registraron movimientos durante la revisión.
